...
Tags: plugin, widget, integration, javascript, google maps, tracking, timetable, trip planner, route planner, chicago, auckland, warsaw, ³ód, budapest, san francisco, toronto, vancouver, maps, public transport, inovatica, timetable visualization, timetables integration, gtfs, planning, route plan
...
This portlet is a part of TransitArt project. It enables easy publishing of public transport timetables. Data can be presented as timetables or journey planner.
...
Note: this portlet has been designed as main element of the page. It is modifying site URL thus some conflicts with another plugins on the site may occur.


== Installation ==

Create war file using maven and copy it to "deploy" directory in your portal instance.
